return {
  {
    ...
    keys = {
      { mode = "n", "s", nil, desc = "Substitue", noremap = false, },
      { mode = "n", "ss", nil, desc = "Substitue current line", noremap = false },
      { mode = "n", "S", nil, desc = "Substitue to eol", noremap = false },
      { mode = "v", "s", nil, desc = "Substitue", noremap = false },
    },
  },
}
