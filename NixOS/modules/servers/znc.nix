...

{
  services.znc = {
    ...
    user = "redm";
    group = "redm";
    # modulePackages = with outoftree.pkgs.${pkgs.stdenv.hostPlatform.system}.zncModules; [
  ...
  systemd.services.znc = {
    ...
    serviceConfig = {
      ...
      Restart = "always";
      # ExecStart = "${outoftree.pkgs.${pkgs.stdenv.hostPlatform.system}.znc}/bin/znc --foreground --datadir ${config.services.znc.dataDir} ${lib.escapeShellArgs config.services.znc.extraFlags}";
