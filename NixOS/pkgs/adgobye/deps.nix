...
[
  (fetchNuGet {
    ...
    version = "3.0.0";
    hash = "sha256-mVy86XhUaDIfL7ErbkiKGj59peThsTDKFQI15GquI7U=";
  })
  (fetchNuGet {
  ...
  (fetchNuGet {
    ...
    version = "8.7.0";
    hash = "sha256-J2Obu5Be6KuvKpSzXiT9sLRyq4E0lWjwEoUQKYCHxMA=";
  })
  (fetchNuGet {
  ...
  (fetchNuGet {
    pname = "Microsoft.Extensions.Diagnostics.Testing";
    version = "8.7.0";
    hash = "sha256-PKG0ZKoB9gEq5RMwtJ82gN/wFH9EhYCCJjfVkRYY0Bo=";
  })
  (fetchNuGet {
  ...
  (fetchNuGet {
    ...
    version = "8.7.0";
    hash = "sha256-RtpT5mchMOyZTSl+CsQixIDxpUDLu/2AGG2aYE7YFQA=";
  })
  (fetchNuGet {
